...
A live demo for the previous version (v1.0.0) is available [right here](https://vikts.github.io/mini-remini/)
...
- Live demo for v2:
  - Deploy BE to Render
  - Use GFPGAN model from [official repo](https://github.com/TencentARC/GFPGAN) 
